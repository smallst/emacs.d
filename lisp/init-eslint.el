...
(defcustom flymake-eslint-executable-name '("npx" "eslint")
  ...
  (let ((default-directory (or flymake-eslint-project-root default-directory)))
    (setq flymake-eslint--process
          (make-process
           ...
           :command (append flymake-eslint-executable-name '("--no-color" "--no-ignore" "--stdin" "--stdin-filename") (buffer-file-name source-buffer) (or flymake-eslint-executable-args ""))
